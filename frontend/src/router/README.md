    ...
    children: [
      {
        ...
        meta: {title: '仪表盘', icon: 'schoollife', permission: ['schoollife']},
        children: [
          {
            path: '/schoollife/analysis',
            name: 'Analysis',
            component: () => import('@/views/schoollife/Analysis'),
            meta: {title: '分析页', permission: ['schoollife']}
          },
          {
            path: '/schoollife/monitor',
            name: 'Monitor',
            hidden: true,
            component: () => import('@/views/schoollife/Monitor'),
            meta: {title: '监控页', permission: ['schoollife']}
          },
          {
            path: '/schoollife/workplace',
            name: 'Workplace',
            component: () => import('@/views/schoollife/Workplace'),
            meta: {title: '工作台', permission: ['schoollife']}
          }
        ]
      },
