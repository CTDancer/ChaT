...
const userNav = options => {
  const nav = [
    ...
    },
    {
      ...
      id: 3,
      meta: {
        title: 'menu.schoollife.workplace',
        target: '_blank',
        show: true
      }
    },
    {
      ...
      id: 2,
      meta: {
        title: 'menu.schoollife.analysis',
        show: true
      },
      component: 'Analysis',
    ...
    },
    {
      ...
      id: 10025,
      meta: {
        title: 'menu.academic.not-permission',
        show: true
      },
    ...
    },
    {
      ...
      id: 10027,
      meta: {
        title: 'menu.academic.server-error',
        show: true
      },
